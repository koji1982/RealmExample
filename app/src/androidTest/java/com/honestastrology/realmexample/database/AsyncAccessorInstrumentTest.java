...
public class AsyncAccessorInstrumentTest {
    ...
    public void getRealmObjectWithId(){
        _scenarioRule.getScenario().onActivity( activity -> {
            setupField( activity );
            Document createdDocument = createTestDocument( swapInMemoryOperator(activity) );
    ...
    public void readAllDocument(){
        _scenarioRule.getScenario().onActivity( activity -> {
            setupField( activity );
            List<Document> createdList = setupMultipleDocuments( swapInMemoryOperator(activity) );
    ...
    public void updateDocument(){
        _scenarioRule.getScenario().onActivity( activity ->{
            setupField( activity );
            Document document = createUnmanagedDocument( swapInMemoryOperator(activity) );
    ...
    public void deleteDocument(){
        _scenarioRule.getScenario().onActivity( activity -> {
            setupField( activity );
            Document targetDocument = createTestDocument( swapInMemoryOperator(activity) );
    ...
    private void setupField(MainActivity activity){
        ...
        _asyncAccessor = extractAsyncAccessor( activity );
        _isInitialized = true;
    }
}
